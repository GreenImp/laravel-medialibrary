...
use Illuminate\Filesystem\FileNotFoundException as ContractFileNotFoundException;
...
class FilesystemAdapter
{
    ...
    public function response($path, $name = null, array $headers = [], $disposition = 'inline')
    {
        ...
        $filename = !is_null($name) ? $name : basename($path);
    ...
    protected function getLocalUrl($path)
    {
        ...
        if (str_contains($path, '/storage/public/')) {
            ...
            if ($position !== false) {
                return substr_replace($path, '/', $position, strlen('/public/'));
            }
    ...
    {
        return with(new Collection($contents))
            ->filter(function($content) use ($type){
